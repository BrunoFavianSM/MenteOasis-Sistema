...
const Footer = () => {
    return (
        <footer className="bg-slate-50 dark:bg-slate-950 text-slate-600 dark:text-slate-400 pt-20 pb-10 transition-colors duration-300 border-t border-slate-200 dark:border-slate-800">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    ...
                    <div>
                        ...
                        <div className="flex gap-4">
                            <a href="https://www.facebook.com/MenteOasisPsicologiaPeru" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 flex items-center justify-center hover:bg-brand-600 dark:hover:bg-brand-600 hover:text-white transition text-slate-600 dark:text-white shadow-sm" aria-label="Facebook">
                                <Facebook size={20} />
                            </a>
                            <a href="https://www.instagram.com/menteoasis_psic/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 flex items-center justify-center hover:bg-brand-600 dark:hover:bg-brand-600 hover:text-white transition text-slate-600 dark:text-white shadow-sm" aria-label="Instagram">
                                <Instagram size={20} />
                            </a>
                            <a href="https://www.tiktok.com/@menteoasis" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 flex items-center justify-center hover:bg-brand-600 dark:hover:bg-brand-600 hover:text-white transition text-slate-600 dark:text-white shadow-sm" aria-label="TikTok">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z" />
                                </svg>
                            </a>
                            <a href="https://linktr.ee/psicoseverin" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 flex items-center justify-center hover:bg-brand-600 dark:hover:bg-brand-600 hover:text-white transition text-slate-600 dark:text-white shadow-sm" aria-label="Linktree">
