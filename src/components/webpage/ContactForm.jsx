                    ...
                    >
                        ...
                        <div className="bg-white dark:bg-slate-800 p-8 rounded-3xl shadow-lg border border-slate-100 dark:border-slate-700 transition-colors duration-300">
                            ...
                            <div className="space-y-3 text-slate-600 dark:text-slate-300 transition-colors duration-300">
                                ...
                                <div className="flex justify-between">
                                    <span className="font-medium">Martes, Miércoles y Jueves</span>
                        ...
                        <div className="bg-gradient-to-br from-brand-600 to-brand-700 dark:from-slate-800 dark:to-slate-900 p-8 rounded-3xl text-white transition-colors duration-300">
                            ...
                            <div className="flex gap-3">
                                <a href="https://www.facebook.com/MenteOasisPsicologiaPeru" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/20 hover:bg-white/30 rounded-full flex items-center justify-center transition">
                                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg>
                                </a>
                                <a href="https://www.instagram.com/menteoasis_psic/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/20 hover:bg-white/30 rounded-full flex items-center justify-center transition">
                                ...
                                <a href="https://www.tiktok.com/@menteoasis" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/20 hover:bg-white/30 rounded-full flex items-center justify-center transition">
